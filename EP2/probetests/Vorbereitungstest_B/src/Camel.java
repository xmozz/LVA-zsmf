 ...
 * maximal pace (speed) determined by its strength and the load it carries. Load slows down the
...
public class Camel {
    ...
    /**
     * Returns the maximal pace of this camel.
     * @return the maximal pace of this camel.
     */
